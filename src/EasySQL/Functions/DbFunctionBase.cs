...
namespace EasySQL
{
    public abstract class DbFunctionBase:IDbFunction
    {
        ...
        /// <returns></returns>
        public virtual string ToInteger(string field)
        {
            return field;
        }
        ...
        public virtual string BitAnd(string field1, string field2)
        {
        ...
        public virtual string BitOr(string field1, string field2)
        {
            return string.Format("({0}|{1})", field1, field2);
        }
        ...
        public virtual string Quote(string content)
        {
        ...
        /// <returns>返回格式化后的字符串值。</returns>
        public virtual string Quote(string content, bool needStringQuote)
        {
        ...
        public virtual string Case(string expression, string field1, string field2)
        {
            return string.Format("case when {0} then {1} else {2} end", expression, field1, field2);
        }
        ...
        public virtual string IsNull(string field1, string field2)
        {
            return string.Format("isnull({0},{1})", field1, field2);
        }
        ...
        /// <param name="fields">字符串字段（可以为多个）。</param>
        /// <returns>返回格式化后的字符串连接函数字符串。</returns>
        public virtual string Concat(string field1, params string[] fields)
        {
        ...
        public virtual string Length(string field)
        {
        ...
        public virtual string Lower(string field)
        {
        ...
        public virtual string Upper(string field)
        {
        ...
        public abstract string ToChar(string field);
        ...
        public abstract string Replace(string field, string oitem, string nitem);
        ...
        public abstract string CharIndex(string field, string item, int start);
        ...
        public virtual string Round(string field, int length)
        {
            return string.Format("round({0},{1})", field,length);
        }
        ...
        public virtual string Floor(string field)
        {
        ...
        public virtual string DateAdd(DatePart datepart, int number, string datefield)
        {
            return DateAdd(datepart, number.ToString(), datefield);
        }
        ...
        /// <param name="datefield">日期字段名称。</param>
        /// <returns>返回格式化后的加上日期（或时间）部分的函数字符串。</returns>
        public abstract string DateAdd(DatePart datepart, string numberExpression, string datefield);
        ...
        /// <returns>返回</returns>
        public abstract string DateDiff(DatePart datepart, string startdate, string enddate);
        ...
        public virtual string Year(string field)
        {
        ...
        public virtual string Month(string field)
        {
        ...
        public virtual string Day(string field)
        {
        ...
        public virtual string Hour(string field)
        {
        ...
        public virtual string Minute(string field)
        {
        ...
        public abstract string WeekDay(string field);

        /// <summary>
        /// 获取查询当前数据库服务器的时间的SQL语句。
        /// </summary>
        public abstract string ServerTimeSql { get; }
        #endregion
    }
}
