...
namespace EasySQL.Test
{
    ...
    public class SqlGenerationTests
    {
        ...
        class UserSchema : SchemaBase
        {
            ...
            public UserSchema(string? alias = null, ISQLDialect? dialect = null) : base(alias ?? string.Empty, dialect) { }
        ...
        class OrderSchema : SchemaBase
        {
            ...
            public override string TableName => TABLE;
            public OrderSchema(string? alias = null, ISQLDialect? dialect = null) : base(alias ?? string.Empty, dialect) { }
        ...
        public void BuildSimpleSelect_ShouldGenerateCorrectSQL()
        {
            ...
            var sql = qb.BuildSql();
            LogSql(sql);
            Assert.Equal("SELECT u.Name,u.Email FROM Users u", sql);
            qb.PrettyPrint = true;
            LogSql(qb.BuildSql());
        }
        ...
        public void SelectAllFields_ShouldGenerateStar()
        {
            ...
            var sql = qb.BuildSql();
            LogSql(sql);
            Assert.Equal("SELECT u.* FROM Users u", sql);
        }
        ...
        public void SelectDistinct_ShouldGenerateDistinctKeyword()
        {
            ...
            var sql = qb.BuildSql();
            LogSql(sql);
            Assert.Equal("SELECT DISTINCT u.Status FROM Users u", sql);
        }
        ...
        public void BuildTemplateSql_ShouldContainPlaceholders()
        {
            ...
            LogSql(sql);
            Assert.Contains("SELECT u.Name FROM Users u", sql);
